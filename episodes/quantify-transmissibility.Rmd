...
The incubation period distribution for many diseases can usually be obtained from the literature. The package `{epiparameter}` contains a library of epidemiological parameters for different diseases obtained from the literature. More about it in the tutorial to [access epidemiological delay distributions](../episodes/delays-access.md).
