...
<p class="text-center" style="background-color: aliceblue">**time from infection to symptom onset** (the incubation period) + **time from symptom onset to case notification** (the reporting time)
.</p>
