...
We also must specify a distribution for the generation time. Here we will use a Lognormal distribution with mean 3.6 and standard deviation 3.1.


```{r}
generation_time_variable <- dist_spec(
  mean = 3.6, sd = 3.1,
  mean_sd = 0.71, sd_sd = 0.77,
...
+ estimates : utilises all data,

+ estimates based on partial data : estimates that are based less data are are therfore more uncertain,
