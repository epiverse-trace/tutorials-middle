...
The estimated new confirmed cases are `r summary(estimates)$estimate[summary(estimates)$measure=="New confirmed cases by infection date"]`
...
Here the daily cases are `r summary(estimates)$estimate[summary(estimates)$measure=="Expected change in daily cases"]`.


#### `Effective reproduction no.`

The effective reproduction number $R_t$ estimate is `r summary(estimates)$estimate[summary(estimates)$measure=="Effective reproduction no."]`.
