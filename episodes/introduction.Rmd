...
Not all primary cases have the same probability to generate a secondary case. The onset and cessation of infectiousness may occur gradually. For `{EpiNow2}`, we can specify it as a probability distribution:
