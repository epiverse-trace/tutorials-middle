...
- In the first set of episodes, we are going to learn how to read case data and epidemiological parameters to the _Quantify transmission_ pipeline. These preliminary task are the __Early tasks__. Packages here are `{readepi}`, `{cleanepi}`, `{linelist}`, `{epiparameter}`, and `{episoap}`.
