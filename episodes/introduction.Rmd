...
### Your last outbreak response

Remember your last experience with outbreak data and reflect in these questions:

- What data sources your needed to understand the outbreak?
- How did you get accessed to that data?
- Is that analysis pipeline you follow reusable for your next response?
