...
The natural history of a disease influence the transmission dynamics. For `{EpiNow2}`, we can specify a relevant epidemiological distributions, the [generation time](../learners/reference.md#generationtime):
