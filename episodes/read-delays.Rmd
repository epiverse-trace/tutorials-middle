...
- Convert delay statistical summaries to distribution parameters.
...
### Lenght of contact tracing and the Serial interval

The **serial interval** is important in the optimization of contact tracing since it provides a time window for the containment of a disease spread ([Fine, 2003](https://academic.oup.com/aje/article/158/11/1039/162725)).
...
### Lenght of quarentine and Incubation period

The **incubation period** distribution is a useful delay to assess for the length of active monitoring or quarantine ([Lauer et al., 2020](https://www.acpjournals.org/doi/10.7326/M20-0504)).
...
### Ebola's effective reproductive number
...
The proportion of presymptomatic transmission in SARS-CoV-2 has been heterogeneous with point estimates of 40% or grater ([Buitrago-Garcia et al., 2022](https://journals.plos.org/plosmedicine/article/figure?id=10.1371/journal.pmed.1003987.g003))
