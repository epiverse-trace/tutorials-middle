...
The epidemiological parameter stored in `covid_serialint` is a **continuous** distribution. Here we plot its *Probability Density Function (PDF)*:
...
```{r}
covid_serialint_discrete_max <- covid_serialint_discrete$prob_dist$q(p = 0.99)
```

::::::::::::::::::::::::::::::::: challenge

### 99th percentile of the incubation period
...
covid_serialint_discrete$prob_dist$r(1000)
# in what quantile we have the 99.9% cumulative probability?
covid_serialint_discrete$prob_dist$q(0.99)
# covid_serialint_discrete$prob_dist$qf(0.99) # as in continuous distribution?
x_limit <- covid_serialint_discrete$prob_dist$q(0.99)
...
si_discrete_y <- covid_serialint_discrete$prob_dist$d(si_discrete_x)
...
covid_incubation_discrete <- epiparameter::discretise(covid_incubation)
covid_incubation_discrete_max <- covid_serialint_discrete$prob_dist$q(p = 0.999)
