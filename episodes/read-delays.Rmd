...
epidist_db(disease = "influenza",epi_dist = "incubation",single_epidist = TRUE)$summary_stats$mean
epidist_db(disease = "influenza",epi_dist = "serial",single_epidist = TRUE)$summary_stats$mean

# symptomatic transmission
epidist_db(disease = "mers",epi_dist = "incubation",single_epidist = TRUE)$summary_stats$median
epidist_db(disease = "mers",epi_dist = "serial",single_epidist = TRUE)$summary_stats$mean
```

```{r,eval=FALSE}
# pre-symptomatic transmission
epidist_db(disease = "covid",epi_dist = "incubation",author = "Stephen",single_epidist = TRUE)$summary_stats$mean
epidist_db(disease = "covid",epi_dist = "serial",author = "Nishiura",single_epidist = TRUE)$summary_stats$mean

# symptomatic transmission
epidist_db(disease = "ebola",epi_dist = "incubation",single_epidist = TRUE)$summary_stats$mean
epidist_db(disease = "ebola",epi_dist = "serial",single_epidist = TRUE)$summary_stats$mean
```
