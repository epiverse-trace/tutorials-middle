...
We can explore this behaviour using the `cfr_rolling()` function. `cfr_rolling()` is utility function that automatically calculates CFR for each day of the outbreak with the data available up to that day, saving the user time.
