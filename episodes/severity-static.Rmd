...
La probabilidad de muerte ajustada indicó que la gravedad de la enfermedad *al final del brote* o con el *últimos datos disponibles en ese momento* es `r out_estimate` con un intervalo de confianza del 95% entre `r out_low` y `r out_high`, con un valor superior al obtenido a través del cálculo directo sin ajustar.
