...
```{r,eval=TRUE}
# calculate probability of finding backward cases with contact traicing window of 2 days
window_2 <- epiparameter::cdf(covid_serialint, q = 2)

window_2

# calculate probability of finding backward cases with contact traicing window of 6 days
...
- A contact tracing method considering contacts up to 2 days pre-onset will capture around `r round(window_2*100, 1)`% of backward cases.

- If this period is extended to 6 days pre-onset, this could include `r round(window_6*100, 1)`% of backward contacts.

- About `r round((window_6 - window_2)*100, 1)`% more backward cases could be captured when extending tracing from 2 to 6 days.
...
Now, Is this result consistent with the duration of quarantine currently recommended in practice?
