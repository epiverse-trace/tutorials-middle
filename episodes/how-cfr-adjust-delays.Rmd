...
Accounting for delays, the expected number of deaths by day 3 is
 $$ D_1 = p_4*\sum\limits_{i=1}^{4}\sum\limits_{j=0}^{i}c_{i}f_{i-j} = $$
 $$ \Rightarrow D_4 = p_4\times [c_4*f_1 +c_3*(f_1 +f_2) + c_2*(f_1+f_2+f_3) + c_1*(f_1+f_2+f_3+f_4)] $$
 $$ \Rightarrow D_4 =  p_4\times[2*0.2 + 3*(0.2+0.4)+1*(0.2+0.4+0.3) +3*(0.2+0.4+0.3+0.1)] = p_4*6.1$$
