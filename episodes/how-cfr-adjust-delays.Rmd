...
\begin{equation}
\begin{split}
D_0 & = p_0 \times \sum_{i=0}^{1} \sum_{j=0}^{i} c_i f_{j-j} \\ 
...
\begin{equation}
\begin{split}
D_1 & = p_1 \times \sum_{i=1}^{2} \sum_{j=0}^{i} c_i f_{i-j} \\ 
...
$$
\Rightarrow p_1 = \frac{b_1*4}{2} = \frac{1}{2} = 0.5
$$
...
\begin{equation}
\begin{split}
D_2 & = p_2 \times \sum_{i=1}^{3} \sum_{j=0}^{i} c_i f_{i-j} \\ 
...
$$
\Rightarrow p_2 = \frac{b_2*7}{3.9} = \frac{1}{3.9} = 0.26
$$
...
\begin{equation}
\begin{split}
D_3 & = p_3 \times \sum_{i=1}^{4} \sum_{j=0}^{i} c_i f_{i-j} \\ 
...
$$
\Rightarrow p_2 = \frac{b_3*9}{6.1} = \frac{1}{6.1} = 0.16
$$
