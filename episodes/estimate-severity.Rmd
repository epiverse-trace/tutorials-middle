...
# https://github.com/CarmenTamayo/Applications-Epiverse-pipelines

# https://github.com/epiverse-trace/episoap/blob/severity-pipeline/inst/rmarkdown/templates/severity/skeleton/skeleton.Rmd
```
...
```{r}
# collect from epicatador and feedback form

# https://github.com/avallecam/epicatador/blob/main/18-cfr.R
```
