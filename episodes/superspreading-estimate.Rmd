...
- The _empirical_ offspring distribution can be modeled using a **negative binomial** distribution with mean $R_{0}$ and dispersion parameter $k$, based on the observed number of secondary cases.
