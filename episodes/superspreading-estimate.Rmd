...
The reproduction number varies at the individual level; that is, the number of secondary infections varies from one infected individual to another. This individual-level count is called the individual reproduction number. The extent to which it differs across individuals is known as the variation in individual reproductive number.
