...
Evaluate the potential for a new Ebola case to generate an explosive large outbreak. Use the appropriate package to access delay data from previous outbreaks.
