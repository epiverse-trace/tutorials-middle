...
The MERS offspring distribution will follow a negative binomial distribution with mean (reproduction number $R$) and dispersion $k$ values estimated from the linelist and contact data of the previous episode.
...
mean `r serial_summary$mean` and standard deviation `r serial_summary$sd`.
