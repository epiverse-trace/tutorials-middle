...
- Estimate case ascertainment or underreporting.
- Integrate `{incidence2}` and `{cfr}`.
- Create an input linelist with `{simulist}`.
...
ifr covid influenza?
<https://github.com/mbevand/covid19-age-stratified-ifr?tab=readme-ov-file#comparing-covid-19-to-seasonal-influenza>

infection assertainment ratio
<https://onlinelibrary.wiley.com/doi/full/10.1111/irv.13181>
...
### time-varying underreporting?

<https://mrc-ide.github.io/global-lmic-reports/DZA/>

### uncertainty in `severity_baseline`

is it possible? to run this as in finalsize uncertainty R0, running over `severity_baseline` samples?
<https://epiverse-trace.github.io/finalsize/articles/uncertainty_params.html>
