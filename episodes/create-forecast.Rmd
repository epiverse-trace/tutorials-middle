...
reported_cases_deaths <- aggregate(
  ...
  data = incidence2::covidregionaldataUK[, c("date", "cases_new", "deaths_new")],
  FUN = sum
)
...
ebola_cases <- read.csv("episodes/data/ebola_cases.csv")
```

```{r,eval=FALSE,echo=TRUE, message = FALSE}
# read data
# assuming it is located in the folder path: data/raw-data/
ebola_cases <- read.csv("data/raw-data/ebola_cases.csv")
