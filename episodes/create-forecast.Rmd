...
```{r}
estimate_cases_to_deaths <- estimate_secondary(reports = reported_cases_deaths[1:30, ], 
...
```{r}
deaths_forecast <- forecast_secondary(estimate = estimate_cases_to_deaths, 
