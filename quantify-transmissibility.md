...
``` output
                        measure               estimate
                         <char>                 <char>
1:       New infections per day   7864 (4694 -- 13266)
2:   Expected change in reports      Likely decreasing
3:   Effective reproduction no.     0.96 (0.73 -- 1.2)
4:               Rate of growth -0.014 (-0.1 -- 0.076)
5: Doubling/halving time (days)      -48 (9.1 -- -6.8)
```
...
+ The exponential growth rate of case numbers is -0.014 (-0.1 -- 0.076).

+ The doubling time (the time taken for case numbers to double) is -48 (9.1 -- -6.8).
