...
``` output
                        measure                estimate
                         <char>                  <char>
1:       New infections per day  20077 (13455 -- 30753)
2:   Expected change in reports                  Stable
3:   Effective reproduction no.      0.97 (0.77 -- 1.2)
4:               Rate of growth -0.011 (-0.091 -- 0.07)
5: Doubling/halving time (days)        -62 (10 -- -7.6)
```
...
``` output
WARN [2025-10-10 15:17:13] epinow: There were 2 divergent transitions after warmup. See
https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
to find out why this is a problem and how to eliminate them. - 
WARN [2025-10-10 15:17:13] epinow: Examine the pairs() plot to diagnose sampling problems
 - 
```
...
``` output
                        measure               estimate
                         <char>                 <char>
1:       New infections per day         91 (50 -- 202)
2:   Expected change in reports             Increasing
3:   Effective reproduction no.       1.6 (1.2 -- 2.5)
4:               Rate of growth 0.04 (0.0041 -- 0.091)
5: Doubling/halving time (days)        17 (7.6 -- 170)
```

The effective reproduction number $R_t$ estimate (on the last date of the data) is 1.6 (1.2 -- 2.5). The exponential growth rate of case numbers is 0.04 (0.0041 -- 0.091).
