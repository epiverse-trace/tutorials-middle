...
``` output
WARN [2025-07-01 02:25:17] epinow: There were 1 divergent transitions after warmup. See
https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
to find out why this is a problem and how to eliminate them. - 
WARN [2025-07-01 02:25:17] epinow: Examine the pairs() plot to diagnose sampling problems
 - 
```
...
``` output
WARN [2025-07-01 02:29:23] epinow: There were 3 divergent transitions after warmup. See
https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
to find out why this is a problem and how to eliminate them. - 
WARN [2025-07-01 02:29:23] epinow: Examine the pairs() plot to diagnose sampling problems
 - 
```
...
``` output
                        measure                estimate
                         <char>                  <char>
1:       New infections per day  20125 (13099 -- 30557)
2:   Expected change in reports       Likely decreasing
3:   Effective reproduction no.      0.97 (0.76 -- 1.2)
4:               Rate of growth -0.012 (-0.096 -- 0.07)
5: Doubling/halving time (days)       -58 (9.9 -- -7.2)
```
...
``` output
WARN [2025-07-01 02:29:31] estimate_secondary (chain: 1): Bulk Effective Samples Size (ESS) is too low, indicating posterior means and medians may be unreliable.
...
``` output
WARN [2025-07-01 02:30:19] epinow: There were 1 divergent transitions after warmup. See
https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
to find out why this is a problem and how to eliminate them. - 
WARN [2025-07-01 02:30:19] epinow: Examine the pairs() plot to diagnose sampling problems
 - 
```
...
``` output
                        measure               estimate
                         <char>                 <char>
1:       New infections per day         92 (49 -- 193)
2:   Expected change in reports             Increasing
3:   Effective reproduction no.       1.6 (1.1 -- 2.4)
4:               Rate of growth 0.04 (0.0014 -- 0.088)
5: Doubling/halving time (days)        17 (7.9 -- 500)
```

The effective reproduction number $R_t$ estimate (on the last date of the data) is 1.6 (1.1 -- 2.4). The exponential growth rate of case numbers is 0.04 (0.0014 -- 0.088).
