...
``` output
WARN [2025-03-28 10:54:47] epinow: There were 2 divergent transitions after warmup. See
https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
to find out why this is a problem and how to eliminate them. - 
WARN [2025-03-28 10:54:47] epinow: Examine the pairs() plot to diagnose sampling problems
 - 
```
...
``` output
WARN [2025-03-28 10:58:12] epinow: There were 1 divergent transitions after warmup. See
https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
to find out why this is a problem and how to eliminate them. - 
WARN [2025-03-28 10:58:12] epinow: Examine the pairs() plot to diagnose sampling problems
 - 
```
...
``` output
                        measure                 estimate
                         <char>                   <char>
1:       New infections per day   19974 (13057 -- 30975)
2:   Expected change in reports                   Stable
3:   Effective reproduction no.       0.97 (0.76 -- 1.2)
4:               Rate of growth -0.011 (-0.097 -- 0.075)
5: Doubling/halving time (days)        -63 (9.3 -- -7.1)
```
...
``` output
WARN [2025-03-28 10:58:19] estimate_secondary (chain: 1): Bulk Effective Samples Size (ESS) is too low, indicating posterior means and medians may be unreliable.
Running the chains for more iterations may help. See
https://mc-stan.org/misc/warnings.html#bulk-ess - 
WARN [2025-03-28 10:58:19] estimate_secondary (chain: 1): Tail Effective Samples Size (ESS) is too low, indicating posterior variances and tail quantiles may be unreliable.
Running the chains for more iterations may help. See
...
``` output
WARN [2025-03-28 10:59:15] epinow: There were 2 divergent transitions after warmup. See
https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
to find out why this is a problem and how to eliminate them. - 
WARN [2025-03-28 10:59:15] epinow: Examine the pairs() plot to diagnose sampling problems
 - 
WARN [2025-03-28 10:59:17] epinow: Bulk Effective Samples Size (ESS) is too low, indicating posterior means and medians may be unreliable.
Running the chains for more iterations may help. See
https://mc-stan.org/misc/warnings.html#bulk-ess - 
WARN [2025-03-28 10:59:18] epinow: Tail Effective Samples Size (ESS) is too low, indicating posterior variances and tail quantiles may be unreliable.
Running the chains for more iterations may help. See
https://mc-stan.org/misc/warnings.html#tail-ess - 
```
...
``` output
                        measure                estimate
                         <char>                  <char>
1:       New infections per day          93 (49 -- 194)
2:   Expected change in reports              Increasing
3:   Effective reproduction no.        1.6 (1.1 -- 2.4)
4:               Rate of growth 0.041 (0.0014 -- 0.089)
5: Doubling/halving time (days)         17 (7.8 -- 500)
```

The effective reproduction number $R_t$ estimate (on the last date of the data) is 1.6 (1.1 -- 2.4). The exponential growth rate of case numbers is 0.041 (0.0014 -- 0.089).
