...
- Explore the data frame output of the `Chain ID`: What is the relationship between the following columns `chain`, `infector`, `infectee`, `generation`, `time`, `simulation_id`?
