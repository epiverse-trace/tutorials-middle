...
epi_contacts <- # <COMPLETE>

# print output
epi_contacts

# visualize the contact network
contact_network <- # <COMPLETE>
...
![Untitled-1](https://hackmd.io/_uploads/H1DVLbsTyx.png){width=25%}
![Untitled](https://hackmd.io/_uploads/BkW48Wo6yg.png){width=25%}

Group 2

![Untitled](https://hackmd.io/_uploads/Hkhg8WspJg.png){width=25%}
![Untitled-1](https://hackmd.io/_uploads/HyIlUWopJx.png){width=25%}

Group 3

![Untitled](https://hackmd.io/_uploads/HkzkUZjpyx.png){width=25%}
![Untitled-1](https://hackmd.io/_uploads/SkjCBZjpJe.png){width=25%}
...
Estimate the potential for large outbreaks using the following available inputs:
...
- Explore the data frame output of the `Simulation ID`: What is the relationship between the following columns `chain`, `infector`, `infectee`, `generation`, `time`, `simulation_id`?
...
simulation_to_explore <- # <COMPLETE>
...
# Simulate one chain -----------------------------------------------------
# add simulation controls, offspring parameters, generation time
...
![Untitled-1](https://hackmd.io/_uploads/H1DVLbsTyx.png){width=25%}
![Untitled](https://hackmd.io/_uploads/BkW48Wo6yg.png){width=25%}
![Untitled-1](https://hackmd.io/_uploads/Sy2QUZiTJl.png){width=25%}

Group 2

![Untitled](https://hackmd.io/_uploads/Hkhg8WspJg.png){width=25%}
![Untitled-1](https://hackmd.io/_uploads/HyIlUWopJx.png){width=25%}
![Untitled](https://hackmd.io/_uploads/SkRyUWjp1x.png){width=25%}

Group 3

![Untitled](https://hackmd.io/_uploads/HkzkUZjpyx.png){width=25%}
![Untitled-1](https://hackmd.io/_uploads/SkjCBZjpJe.png){width=25%}
![Untitled](https://hackmd.io/_uploads/BkfABZopye.png){width=25%}
