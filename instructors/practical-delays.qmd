...
![image](https://hackmd.io/_uploads/BJl8wYiDC.png){width=50%}
...
With reporting delay plus Incubation time:
![image](https://hackmd.io/_uploads/H1ZrYYsvR.png){width=50%}
...
With reporting delay plus Incubation time:
![image](https://hackmd.io/_uploads/Byu3FFoDR.png){width=50%}
...
`(Increasing/Stable/Decreasing)` with the estimated new infections, on average, of
`29` with 90% credible interval of `11` to `62`.
...
`2.1`, with a 90% credible interval of `1.1` to `3.0`.

+ The exponential growth rate of case reports is, on average
`0.06`, with a 90% credible interval of `-0.01` to `0.10`.

+ The doubling time (the time taken for case reports to double) is, on average,
`12.0`, with a 90% credible interval of `6.9` to `-70`.
