...
- As of `15th June 2015`, the MERS cases in the `Male` population have a delay-adjusted case fatality risk of `16.3%` with a 95% confidence interval between `7.4%` and `29.1%`.
...
- `cfr::static()` assumption and limitations
    ...
    - Early data had limitations (limited testing, changing case definitions, often only most severe being tested -a.k.a., preferential assessertainment-). So neither method (aCFR nor nCFR) gives the ‘true’ % of fatal symptomatic cases. 
