...
| Group | Incidence        | Filter        | Link                                                                        |
|-------|------------------|---------------|-----------------------------------------------------------------------------|
| 1     | Diamond Princess | First 35 days | <https://epiverse-trace.github.io/tutorials-middle/data/diamond_70days.rds> |
| 2     | Diamond Princess | Complete data | <https://epiverse-trace.github.io/tutorials-middle/data/diamond_70days.rds> |
| 3     | MERS 133 cases   | Female        | <https://epiverse-trace.github.io/tutorials-middle/data/mers_35days.rds>    |
| 4     | MERS 133 cases   | Male          | <https://epiverse-trace.github.io/tutorials-middle/data/mers_35days.rds>    |
...
# Read reported cases -----------------------------------------------------
mers_dat <- read_rds(
  "https://epiverse-trace.github.io/tutorials-middle/data/mers_35days.rds"
)
...
| Diamond                                             | Mers                                                |
|-----------------------------------------------------|-----------------------------------------------------|
| ![image](https://hackmd.io/_uploads/ryWr0vNRyx.png) | ![image](https://hackmd.io/_uploads/BJExy_4A1e.png) |

| Data Input | Filter Category                    | estimate | low   | high  |
|------------|------------------------------------|----------|-------|-------|
| diamond    | date \< 2020-03-10                 | 0.011    | 0.005 | 0.022 |
| diamond    | date \< 2020-03-10 + delay density | 0.017    | 0.008 | 0.032 |
| diamond    | no filter                          | 0.020    | 0.011 | 0.033 |
| diamond    | delay density                      | 0.020    | 0.011 | 0.033 |
| mers       | sex == “F”                         | 0.054    | 0.011 | 0.149 |
| mers       | sex == “F” + delay density         | 0.101    | 0.026 | 0.241 |
| mers       | sex == “M”                         | 0.089    | 0.036 | 0.174 |
| mers       | sex == “M” + delay density         | 0.163    | 0.074 | 0.291 |
...
- The MERS incidence curve seems to be in a decay phase. However, it is
  expected to have death reports in upcoming dates, as in the COVID
  Diamond Princess data.
- For COVID, the March 10th aCFR central estimate is closer to the nCFR
...
- Authors report that “Males are over-represented among cases. (…) The
  ...
  transmissions.”
  <https://www.eurosurveillance.org/content/10.2807/1560-7917.ES2013.18.39.20596>
