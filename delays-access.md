...
- The `{EpiEstim}` package allows real-time estimation of the [reproduction number](../learners/reference.md#effectiverepro) using case data over time, reflecting how transmission changes based on when symptoms appear. 
