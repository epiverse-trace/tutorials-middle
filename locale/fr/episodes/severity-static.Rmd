...
**R packages**: `{cfr}`, `{epiparameter}`, `{outbreaks}`, `{tidyverse}`.
...
Si vous recevez un message d'erreur, rendez-vous sur la [page principale de configuration](../learners/setup#configuration-des-logiciels).
...
sarscov2_input <- readr::read_csv(
  file = file.path("../../../episodes", "data", "sarscov2_cases_deaths.csv")
)
```
