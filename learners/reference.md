...
: Probability distribution of a key epidemiological time period ([Althobait et al., 2022, Figure 5 and 6](https://www.sciencedirect.com/science/article/pii/S2468042722000537#fig5)). For a full summary of key epidemiological periods refer to [Xiang et al., 2021](https://www.sciencedirect.com/science/article/pii/S2468042721000038/#fig4). [Middle task tutorials](https://epiverse-trace.github.io/tutorials-middle/delays-access.html) contain episodes on this topic.
