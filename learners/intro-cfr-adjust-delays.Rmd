...
Compare this against the Day 0 and Day 1 calculations below: $p_t$ is obtained by dividing the observed deaths $D_t$ by the expected-outcomes term ($0.6$ on Day 0, $2$ on Day 1).
