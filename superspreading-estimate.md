...
- While $R_{0}$ captures the average transmission in the population, the **individual reproduction number** is the random variable representing the number of secondary _infections_ caused by a particular _infected_ individual in that population.
